...
public class PoliceArmorItem extends ArmorItem implements IAnimatable {
    @Override
    ...
    public PoliceArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
